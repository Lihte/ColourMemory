...
public class GameLogic
{
    ...
    public GameBoard GameBoard { get => _gameBoard ?? throw new InvalidOperationException("GameBoard has not been initialized. Always run ResetGame after construction."); }
    ...
    /// </summary>
    public GameLogic(IRandomProvider randomProvider)
    {
        _rnd = randomProvider;
